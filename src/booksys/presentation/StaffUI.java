...
public class StaffUI extends Canvas implements BookingObserver 
{
  ...
  {
	  AddMenuDialog d 
	    = new AddMenuDialog(parentFrame,
	    		"Add Menu");
	  
	  d.show();
	  
	  if(d.isConfirmed()) {
		bs.addmenu(d.getMenuName(),
		  d.getPrice(),
		  d.getCategory());
	  }
  }
  ...
  {
	  RemoveMenuDialog d 
	    = new RemoveMenuDialog(parentFrame,
	    		"Remove Menu");
	  
	  d.show();
	  
	  if(d.isConfirmed()) {
			bs.removemenu(d.getMenuName());
		  }
  }
  ...
  {
	  AddNoShowDialog d 
	    = new AddNoShowDialog(parentFrame,
	    		"Add NoShow Customer");
	  
	  d.show();
	  
	  if(d.isConfirmed()) {
			bs.addnoshow(d.getCustomerName(),
			  d.getPhoneNumber());
		  }
  }
  ...
  void removenoshow()
  {
	  RemoveNoShowDialog d 
	    = new RemoveNoShowDialog(parentFrame,
	    		"Remove NoShow Customer");
	  
	  d.show();
	  
	  if(d.isConfirmed()) {
		  bs.removenoshow(d.getCustomerName(),
				  d.getPhoneNumber());
		  }
  }
}
